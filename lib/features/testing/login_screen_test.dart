  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Scaffold(
          // ВАЖНО: Отключаем автоматический ресайз, чтобы экран не дергался
          // Мы будем двигать кнопку вручную через Padding
          ...
          body: SafeArea(
            child: Container(
              ...
              child: Stack(
                children: [
                  // 1. Прокручиваемый контент формы
                  SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Отступ снизу, чтобы контент не скрывался за кнопкой при прокрутке
                        SizedBox(height: 80),
                      ],
                    ),
                  ),

                  // 2. Кнопка, которая "прилипает" к низу
                  Align(
                    alignment: Alignment.bottomCenter,
                    child: Padding(
                      // Ключевой момент: сдвигаем кнопку вверх на высоту клавиатуры
